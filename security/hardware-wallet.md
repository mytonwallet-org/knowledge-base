...
2. Open My Wallet and go to **Settings → Hardware Wallet** (or choose Ledger during wallet import).
3. Connect:
...
- Ledger wallets are **TON-only** in My Wallet (no TRON or Solana via Ledger at this time).
