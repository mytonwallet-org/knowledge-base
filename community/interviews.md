# Interviews & AMA Notes

## What This File Covers

This file summarizes interview-style material without treating every quote as a product guarantee.
...
Use this interview for questions about the project's vision, trust model, and product mindset, not for step-by-step support guidance.
...
Use this AMA for questions about product direction, founder intent, `@push`, and the reasoning behind major UX decisions. For precise feature behavior, prefer the topical docs and `history/product-timeline.md`.
